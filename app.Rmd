...
-----------------------------------------------------------------------
### Chart 1: Rate of Business Creation for Selected States/Years
...
### Chart 2: Rate of Business and Job Creation for Selected States/Years
...
renderPlot({
  if(input$plot_type == "Box Plot"){
    (ggplot(busdyn, aes(x = Year, y = Rate_of_reallocation_prev_year)) +
               geom_boxplot()+
...
Row {data-height=350}
-----------------------------------------------------------------------
### Average Annual Rate of Business Creation
...
### Max. Annual Rate of Business Creation
...
### Min. Annual Rate of Business Creation
